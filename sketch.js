...
//Player.debug = true
Player.setCollider("rectangle",0,-20,20,70)
...
if(Player.y > 609 || Player.isTouching(rockG)){
    background("black")
    Player.velocityY = 0
    textSize(20)
    stroke("Blue")
    ...
    Rocks.x = 99999999999999999999999999999999999999999999999999999999
}
